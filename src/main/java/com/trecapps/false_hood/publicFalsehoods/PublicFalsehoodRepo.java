...
public interface PublicFalsehoodRepo extends JpaRepository<PublicFalsehood, BigInteger> {
    ...
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.region = :region and f.dateMade >= :begin and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBetweenAndByRegion(Pageable p, String terms, @Param("offType")byte offType, @Param("begin") Date begin, @Param("end")Date end,
    		@Param("region") Region region);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.institution = :inst and f.dateMade >= :begin and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBetweenAndByInstitution(Pageable p, String terms, @Param("offType")byte offType, @Param("begin") Date begin, @Param("end")Date end,
    		@Param("inst") Institution i);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.region = :region and f.institution = :inst and f.dateMade >= :begin and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBetweenAndByRegionAndInst(Pageable p, String terms, @Param("offType")byte offType, @Param("begin") Date begin, @Param("end")Date end,
    		@Param("region") Region region, @Param("inst") Institution i);
    ...
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.official = :official and f.region = :region and f.dateMade >= :begin and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBetweenAndByOfficialRegion(Pageable p, String terms, @Param("offType")byte offType, @Param("begin") Date begin, @Param("end")Date end,
    		@Param("official")PublicFigure official, @Param("region") Region region);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.official = :official and f.institution = :inst and f.dateMade >= :begin and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBetweenAndByOfficialInstitution(Pageable p, String terms, @Param("offType")byte offType, @Param("begin") Date begin, @Param("end")Date end,
    		@Param("official")PublicFigure official, @Param("inst") Institution i);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.official = :official and f.region = :region and f.institution = :inst and f.dateMade >= :begin and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBetweenAndByOfficialRegionAndInst(Pageable p, String terms, @Param("offType")byte offType, @Param("begin") Date begin, @Param("end")Date end,
    		@Param("official")PublicFigure official, @Param("region") Region region, @Param("inst") Institution i);
    ...
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.severity <= :minSeverity and f.region = :region and f.dateMade >= :begin and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBetweenAndBySeverityRegion(Pageable p, String terms, @Param("offType")byte offType, @Param("begin") Date begin, @Param("end")Date end,
    		@Param("maxSeverity") byte maxSeverity, @Param("minSeverity") byte minSeverity, @Param("region") Region region);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.severity <= :minSeverity and f.institution = :inst and f.dateMade >= :begin and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBetweenAndBySeverityInstitution(Pageable p, String terms, @Param("offType")byte offType, @Param("begin") Date begin, @Param("end")Date end,
    		@Param("maxSeverity") byte maxSeverity, @Param("minSeverity") byte minSeverity, @Param("inst") Institution i);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.severity <= :minSeverity and f.region = :region and f.institution = :inst and f.dateMade >= :begin and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBetweenAndBySeverityRegionAndInst(Pageable p, String terms, @Param("offType")byte offType, @Param("begin") Date begin, @Param("end")Date end,
    		@Param("maxSeverity") byte maxSeverity, @Param("minSeverity") byte minSeverity, @Param("region") Region region, @Param("inst") Institution i);
    ...
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.severity <= :minSeverity and f.official = :official and f.region = :region and f.dateMade >= :begin and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBetweenAndBySeverityOfficialRegion(Pageable p, String terms, @Param("offType")byte offType, @Param("begin") Date begin, @Param("end")Date end,
    		@Param("maxSeverity") byte maxSeverity, @Param("minSeverity") byte minSeverity, @Param("official")PublicFigure official, @Param("region") Region region);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.severity <= :minSeverity and f.official = :official and f.institution = :inst and f.dateMade >= :begin and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBetweenAndBySeverityOfficialInstitution(Pageable p, String terms, @Param("offType")byte offType, @Param("begin") Date begin, @Param("end")Date end,
    		@Param("maxSeverity") byte maxSeverity, @Param("minSeverity") byte minSeverity, @Param("official")PublicFigure official, @Param("inst") Institution i);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.severity <= :minSeverity and f.official = :official and f.region = :region and f.institution = :inst and f.dateMade >= :begin and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBetweenAndBySeverityOfficialRegionAndInst(Pageable p, String terms, @Param("offType")byte offType, @Param("begin") Date begin, @Param("end")Date end,
    		@Param("maxSeverity") byte maxSeverity, @Param("minSeverity") byte minSeverity, @Param("official")PublicFigure official, @Param("region") Region region, @Param("inst") Institution i);
    ...
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity <= :minSeverity and f.region = :region and f.dateMade >= :begin and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBetweenAndByMinSeverityRegion(Pageable p, String terms, @Param("offType")byte offType, @Param("begin") Date begin, @Param("end")Date end,
    		@Param("minSeverity") byte minSeverity, @Param("region") Region region);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity <= :minSeverity and f.institution = :inst and f.dateMade >= :begin and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBetweenAndByMinSeverityInstitution(Pageable p, String terms, @Param("offType")byte offType, @Param("begin") Date begin, @Param("end")Date end,
    		@Param("minSeverity") byte minSeverity, @Param("inst") Institution i);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity <= :minSeverity and f.region = :region and f.institution = :inst and f.dateMade >= :begin and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBetweenAndByMinSeverityRegionAndInst(Pageable p, String terms, @Param("offType")byte offType, @Param("begin") Date begin, @Param("end")Date end,
    		@Param("minSeverity") byte minSeverity, @Param("region") Region region, @Param("inst") Institution i);
    ...
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity <= :minSeverity and f.official = :official and f.region = :region and f.dateMade >= :begin and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBetweenAndByMinSeverityOfficialRegion(Pageable p, String terms, @Param("offType")byte offType, @Param("begin") Date begin, @Param("end")Date end,
    		@Param("minSeverity") byte minSeverity, @Param("official")PublicFigure official, @Param("region") Region region);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity <= :minSeverity and f.official = :official and f.institution = :inst and f.dateMade >= :begin and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBetweenAndByMinSeverityOfficialInstitution(Pageable p, String terms, @Param("offType")byte offType, @Param("begin") Date begin, @Param("end")Date end,
    		@Param("minSeverity") byte minSeverity, @Param("official")PublicFigure official, @Param("inst") Institution i);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity <= :minSeverity and f.official = :official and f.region = :region and f.institution = :inst and f.dateMade >= :begin and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBetweenAndByMinSeverityOfficialRegionAndInst(Pageable p, String terms, @Param("offType")byte offType, @Param("begin") Date begin, @Param("end")Date end,
    		@Param("minSeverity") byte minSeverity, @Param("official")PublicFigure official, @Param("region") Region region, @Param("inst") Institution i);
    ...
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.region = :region and f.dateMade >= :begin and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBetweenAndByMaxSeverityRegion(Pageable p, String terms, @Param("offType")byte offType, @Param("begin") Date begin, @Param("end")Date end,
    		@Param("maxSeverity") byte maxSeverity, @Param("region") Region r);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.institution = :inst and f.dateMade >= :begin and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBetweenAndByMaxSeverityInstitution(Pageable p, String terms, @Param("offType")byte offType, @Param("begin") Date begin, @Param("end")Date end,
    		@Param("maxSeverity") byte maxSeverity, @Param("inst") Institution i);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.region = :region and f.institution = :inst and f.dateMade >= :begin and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBetweenAndByMaxSeverityRegionAndInst(Pageable p, String terms, @Param("offType")byte offType, @Param("begin") Date begin, @Param("end")Date end,
    		@Param("maxSeverity") byte maxSeverity, @Param("region") Region r, @Param("inst") Institution i);
    ...
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.official = :official and f.region = :region and f.dateMade >= :begin and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBetweenAndByMaxSeverityOfficialRegion(Pageable p, String terms, @Param("offType")byte offType, @Param("begin") Date begin, @Param("end")Date end,
    		@Param("maxSeverity") byte maxSeverity, @Param("official")PublicFigure official, @Param("region") Region region);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.official = :official and f.institution = :inst and f.dateMade >= :begin and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBetweenAndByMaxSeverityOfficialInstitution(Pageable p, String terms, @Param("offType")byte offType, @Param("begin") Date begin, @Param("end")Date end,
    		@Param("maxSeverity") byte maxSeverity, @Param("official")PublicFigure official, @Param("inst") Institution i);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.official = :official and f.region = :region and f.institution = :inst and f.dateMade >= :begin and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBetweenAndByMaxSeverityOfficialRegionAndInst(Pageable p, String terms, @Param("offType")byte offType, @Param("begin") Date begin, @Param("end")Date end,
    		@Param("maxSeverity") byte maxSeverity, @Param("official")PublicFigure official, @Param("region") Region region, @Param("inst") Institution i);
    ...
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.region = :region  and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBeforeAndByRegion(Pageable p, String terms, @Param("offType")byte offType,  @Param("end")Date end,
    		@Param("region") Region region);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.institution = :inst  and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBeforeAndByInstitution(Pageable p, String terms, @Param("offType")byte offType,  @Param("end")Date end,
    		@Param("inst") Institution i);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.region = :region and f.institution = :inst  and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBeforeAndByRegionAndInst(Pageable p, String terms, @Param("offType")byte offType,  @Param("end")Date end,
    		@Param("region") Region region, @Param("inst") Institution i);
    ...
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.official = :official and f.region = :region  and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBeforeAndByOfficialRegion(Pageable p, String terms, @Param("offType")byte offType,  @Param("end")Date end,
    		@Param("official")PublicFigure official, @Param("region") Region region);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.official = :official and f.institution = :inst  and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBeforeAndByOfficialInstitution(Pageable p, String terms, @Param("offType")byte offType,  @Param("end")Date end,
    		@Param("official")PublicFigure official, @Param("inst") Institution i);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.official = :official and f.region = :region and f.institution = :inst  and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBeforeAndByOfficialRegionAndInst(Pageable p, String terms, @Param("offType")byte offType,  @Param("end")Date end,
    		@Param("official")PublicFigure official, @Param("region") Region region, @Param("inst") Institution i);
    ...
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.severity <= :minSeverity and f.region = :region  and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBeforeAndBySeverityRegion(Pageable p, String terms, @Param("offType")byte offType,  @Param("end")Date end,
    		@Param("maxSeverity") byte maxSeverity, @Param("minSeverity") byte minSeverity, @Param("region") Region region);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.severity <= :minSeverity and f.institution = :inst  and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBeforeAndBySeverityInstitution(Pageable p, String terms, @Param("offType")byte offType,  @Param("end")Date end,
    		@Param("maxSeverity") byte maxSeverity, @Param("minSeverity") byte minSeverity, @Param("inst") Institution i);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.severity <= :minSeverity and f.region = :region and f.institution = :inst  and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBeforeAndBySeverityRegionAndInst(Pageable p, String terms, @Param("offType")byte offType,  @Param("end")Date end,
    		@Param("maxSeverity") byte maxSeverity, @Param("minSeverity") byte minSeverity, @Param("region") Region region, @Param("inst") Institution i);
    ...
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.severity <= :minSeverity and f.official = :official and f.region = :region  and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBeforeAndBySeverityOfficialRegion(Pageable p, String terms, @Param("offType")byte offType,  @Param("end")Date end,
    		@Param("maxSeverity") byte maxSeverity, @Param("minSeverity") byte minSeverity, @Param("official")PublicFigure official, @Param("region") Region region);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.severity <= :minSeverity and f.official = :official and f.institution = :inst  and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBeforeAndBySeverityOfficialInstitution(Pageable p, String terms, @Param("offType")byte offType,  @Param("end")Date end,
    		@Param("maxSeverity") byte maxSeverity, @Param("minSeverity") byte minSeverity, @Param("official")PublicFigure official, @Param("inst") Institution i);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.severity <= :minSeverity and f.official = :official and f.region = :region and f.institution = :inst  and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBeforeAndBySeverityOfficialRegionAndInst(Pageable p, String terms, @Param("offType")byte offType,  @Param("end")Date end,
    		@Param("maxSeverity") byte maxSeverity, @Param("minSeverity") byte minSeverity, @Param("official")PublicFigure official, @Param("region") Region region, @Param("inst") Institution i);
    ...
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity <= :minSeverity and f.region = :region  and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBeforeAndByMinSeverityRegion(Pageable p, String terms, @Param("offType")byte offType,  @Param("end")Date end,
    		@Param("minSeverity") byte minSeverity, @Param("region") Region region);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity <= :minSeverity and f.institution = :inst  and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBeforeAndByMinSeverityInstitution(Pageable p, String terms, @Param("offType")byte offType,  @Param("end")Date end,
    		@Param("minSeverity") byte minSeverity, @Param("inst") Institution i);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity <= :minSeverity and f.region = :region and f.institution = :inst  and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBeforeAndByMinSeverityRegionAndInst(Pageable p, String terms, @Param("offType")byte offType,  @Param("end")Date end,
    		@Param("minSeverity") byte minSeverity, @Param("region") Region region, @Param("inst") Institution i);
    ...
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity <= :minSeverity and f.official = :official and f.region = :region  and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBeforeAndByMinSeverityOfficialRegion(Pageable p, String terms, @Param("offType")byte offType,  @Param("end")Date end,
    		@Param("minSeverity") byte minSeverity, @Param("official")PublicFigure official, @Param("region") Region region);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity <= :minSeverity and f.official = :official and f.institution = :inst  and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBeforeAndByMinSeverityOfficialInstitution(Pageable p, String terms, @Param("offType")byte offType,  @Param("end")Date end,
    		@Param("minSeverity") byte minSeverity, @Param("official")PublicFigure official, @Param("inst") Institution i);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity <= :minSeverity and f.official = :official and f.region = :region and f.institution = :inst  and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBeforeAndByMinSeverityOfficialRegionAndInst(Pageable p, String terms, @Param("offType")byte offType,  @Param("end")Date end,
    		@Param("minSeverity") byte minSeverity, @Param("official")PublicFigure official, @Param("region") Region region, @Param("inst") Institution i);
    ...
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.region = :region  and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBeforeAndByMaxSeverityRegion(Pageable p, String terms, @Param("offType")byte offType,  @Param("end")Date end,
    		@Param("maxSeverity") byte maxSeverity, @Param("region") Region r);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.institution = :inst  and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBeforeAndByMaxSeverityInstitution(Pageable p, String terms, @Param("offType")byte offType,  @Param("end")Date end,
    		@Param("maxSeverity") byte maxSeverity, @Param("inst") Institution i);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.region = :region and f.institution = :inst  and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBeforeAndByMaxSeverityRegionAndInst(Pageable p, String terms, @Param("offType")byte offType,  @Param("end")Date end,
    		@Param("maxSeverity") byte maxSeverity, @Param("region") Region r, @Param("inst") Institution i);
    ...
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.official = :official and f.region = :region  and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBeforeAndByMaxSeverityOfficialRegion(Pageable p, String terms, @Param("offType")byte offType,  @Param("end")Date end,
    		@Param("maxSeverity") byte maxSeverity, @Param("official")PublicFigure official, @Param("region") Region region);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.official = :official and f.institution = :inst  and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBeforeAndByMaxSeverityOfficialInstitution(Pageable p, String terms, @Param("offType")byte offType,  @Param("end")Date end,
    		@Param("maxSeverity") byte maxSeverity, @Param("official")PublicFigure official, @Param("inst") Institution i);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.official = :official and f.region = :region and f.institution = :inst  and f.dateMade <= :end")
    List<PublicFalsehood> getRejectedFalsehoodsBeforeAndByMaxSeverityOfficialRegionAndInst(Pageable p, String terms, @Param("offType")byte offType,  @Param("end")Date end,
    		@Param("maxSeverity") byte maxSeverity, @Param("official")PublicFigure official, @Param("region") Region region, @Param("inst") Institution i);
    
    ///// Now Do no Dates
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.region = :region ")
    List<PublicFalsehood> getRejectedFalsehoodsByRegion(Pageable p, String terms, @Param("offType")byte offType, 
    		@Param("region") Region region);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.institution = :inst ")
    List<PublicFalsehood> getRejectedFalsehoodsByInstitution(Pageable p, String terms, @Param("offType")byte offType, 
    		@Param("inst") Institution i);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.region = :region and f.institution = :inst ")
    List<PublicFalsehood> getRejectedFalsehoodsByRegionAndInst(Pageable p, String terms, @Param("offType")byte offType, 
    		@Param("region") Region region, @Param("inst") Institution i);
    ...
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.official = :official and f.region = :region ")
    List<PublicFalsehood> getRejectedFalsehoodsByOfficialRegion(Pageable p, String terms, @Param("offType")byte offType, 
    		@Param("official")PublicFigure official, @Param("region") Region region);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.official = :official and f.institution = :inst ")
    List<PublicFalsehood> getRejectedFalsehoodsByOfficialInstitution(Pageable p, String terms, @Param("offType")byte offType, 
    		@Param("official")PublicFigure official, @Param("inst") Institution i);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.official = :official and f.region = :region and f.institution = :inst ")
    List<PublicFalsehood> getRejectedFalsehoodsByOfficialRegionAndInst(Pageable p, String terms, @Param("offType")byte offType, 
    		@Param("official")PublicFigure official, @Param("region") Region region, @Param("inst") Institution i);
    ...
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.severity <= :minSeverity and f.region = :region ")
    List<PublicFalsehood> getRejectedFalsehoodsBySeverityRegion(Pageable p, String terms, @Param("offType")byte offType, 
    		@Param("maxSeverity") byte maxSeverity, @Param("minSeverity") byte minSeverity, @Param("region") Region region);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.severity <= :minSeverity and f.institution = :inst ")
    List<PublicFalsehood> getRejectedFalsehoodsBySeverityInstitution(Pageable p, String terms, @Param("offType")byte offType, 
    		@Param("maxSeverity") byte maxSeverity, @Param("minSeverity") byte minSeverity, @Param("inst") Institution i);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.severity <= :minSeverity and f.region = :region and f.institution = :inst ")
    List<PublicFalsehood> getRejectedFalsehoodsBySeverityRegionAndInst(Pageable p, String terms, @Param("offType")byte offType, 
    		@Param("maxSeverity") byte maxSeverity, @Param("minSeverity") byte minSeverity, @Param("region") Region region, @Param("inst") Institution i);
    ...
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.severity <= :minSeverity and f.official = :official and f.region = :region ")
    List<PublicFalsehood> getRejectedFalsehoodsBySeverityOfficialRegion(Pageable p, String terms, @Param("offType")byte offType, 
    		@Param("maxSeverity") byte maxSeverity, @Param("minSeverity") byte minSeverity, @Param("official")PublicFigure official, @Param("region") Region region);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.severity <= :minSeverity and f.official = :official and f.institution = :inst ")
    List<PublicFalsehood> getRejectedFalsehoodsBySeverityOfficialInstitution(Pageable p, String terms, @Param("offType")byte offType, 
    		@Param("maxSeverity") byte maxSeverity, @Param("minSeverity") byte minSeverity, @Param("official")PublicFigure official, @Param("inst") Institution i);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.severity <= :minSeverity and f.official = :official and f.region = :region and f.institution = :inst ")
    List<PublicFalsehood> getRejectedFalsehoodsBySeverityOfficialRegionAndInst(Pageable p, String terms, @Param("offType")byte offType, 
    		@Param("maxSeverity") byte maxSeverity, @Param("minSeverity") byte minSeverity, @Param("official")PublicFigure official, @Param("region") Region region, @Param("inst") Institution i);
    ...
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity <= :minSeverity and f.region = :region ")
    List<PublicFalsehood> getRejectedFalsehoodsByMinSeverityRegion(Pageable p, String terms, @Param("offType")byte offType, 
    		@Param("minSeverity") byte minSeverity, @Param("region") Region region);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity <= :minSeverity and f.institution = :inst ")
    List<PublicFalsehood> getRejectedFalsehoodsByMinSeverityInstitution(Pageable p, String terms, @Param("offType")byte offType, 
    		@Param("minSeverity") byte minSeverity, @Param("inst") Institution i);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity <= :minSeverity and f.region = :region and f.institution = :inst ")
    List<PublicFalsehood> getRejectedFalsehoodsByMinSeverityRegionAndInst(Pageable p, String terms, @Param("offType")byte offType, 
    		@Param("minSeverity") byte minSeverity, @Param("region") Region region, @Param("inst") Institution i);
    ...
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity <= :minSeverity and f.official = :official and f.region = :region ")
    List<PublicFalsehood> getRejectedFalsehoodsByMinSeverityOfficialRegion(Pageable p, String terms, @Param("offType")byte offType, 
    		@Param("minSeverity") byte minSeverity, @Param("official")PublicFigure official, @Param("region") Region region);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity <= :minSeverity and f.official = :official and f.institution = :inst ")
    List<PublicFalsehood> getRejectedFalsehoodsByMinSeverityOfficialInstitution(Pageable p, String terms, @Param("offType")byte offType, 
    		@Param("minSeverity") byte minSeverity, @Param("official")PublicFigure official, @Param("inst") Institution i);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity <= :minSeverity and f.official = :official and f.region = :region and f.institution = :inst ")
    List<PublicFalsehood> getRejectedFalsehoodsByMinSeverityOfficialRegionAndInst(Pageable p, String terms, @Param("offType")byte offType, 
    		@Param("minSeverity") byte minSeverity, @Param("official")PublicFigure official, @Param("region") Region region, @Param("inst") Institution i);
    ...
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.region = :region ")
    List<PublicFalsehood> getRejectedFalsehoodsByMaxSeverityRegion(Pageable p, String terms, @Param("offType")byte offType, 
    		@Param("maxSeverity") byte maxSeverity, @Param("region") Region r);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.institution = :inst ")
    List<PublicFalsehood> getRejectedFalsehoodsByMaxSeverityInstitution(Pageable p, String terms, @Param("offType")byte offType, 
    		@Param("maxSeverity") byte maxSeverity, @Param("inst") Institution i);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.region = :region and f.institution = :inst ")
    List<PublicFalsehood> getRejectedFalsehoodsByMaxSeverityRegionAndInst(Pageable p, String terms, @Param("offType")byte offType, 
    		@Param("maxSeverity") byte maxSeverity, @Param("region") Region r, @Param("inst") Institution i);
    ...
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.official = :official and f.region = :region ")
    List<PublicFalsehood> getRejectedFalsehoodsByMaxSeverityOfficialRegion(Pageable p, String terms, @Param("offType")byte offType, 
    		@Param("maxSeverity") byte maxSeverity, @Param("official")PublicFigure official, @Param("region") Region region);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.official = :official and f.institution = :inst ")
    List<PublicFalsehood> getRejectedFalsehoodsByMaxSeverityOfficialInstitution(Pageable p, String terms, @Param("offType")byte offType, 
    		@Param("maxSeverity") byte maxSeverity, @Param("official")PublicFigure official, @Param("inst") Institution i);
    
    @Query("select f from PublicFalsehood f where f.tags like %:terms% and (:offType > 15 or f.officialType = :offType) and f.status > 4 and f.severity >= :maxSeverity and f.official = :official and f.region = :region and f.institution = :inst ")
    List<PublicFalsehood> getRejectedFalsehoodsByMaxSeverityOfficialRegionAndInst(Pageable p, String terms, @Param("offType")byte offType, 
    		@Param("maxSeverity") byte maxSeverity, @Param("official")PublicFigure official, @Param("region") Region region, @Param("inst") Institution i);
